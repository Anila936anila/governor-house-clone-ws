...
const Compulsory = () => {
  return (
    <div className='xl:w-[1300px] lg:w-[90%] w-[95%] m-auto mt-10 mb-10'>
      <h1 className=' lg:text-4xl sm:text-4xl text-2xl sm:text-left text-center text-main font-extra-bold mt-10'>Core Courses Sequence</h1>
      <div className='grid xl-lg:grid-cols-4 sm:grid-cols-3 grid-cols-1 xl-lg:gap-10 gap-5 mt-10'>
        ...
        <div className='overflow-hidden h-fit box-shadow rounded-lg flex flex-col justify-center items-center text-center text-zinc-600 text-lg font-bold'>
          <div>
            <Image alt='programming fundamental' src={programmingFundamentals} className='object-cover w-full' height={'300'} />
          </div>
        ...
        <div className='overflow-hidden h-fit box-shadow rounded-lg flex flex-col justify-center items-center text-center text-zinc-600 text-lg font-bold'>
        <div>
        <Image alt='earnasyoulearn' src={EarnAsYouLearn} className='object-cover w-full' height={'300'} />
        </div>
        <div className='px-4 flex justify-center items-center h-[70px]'>
            <text>
              Earn As you Learn
