...
const Footer = () => {
  return (
    <div>
     <footer className='bg-gray-100 py-8 px-10 text-grey-800 flex justify-around'>
<div className='mt-10 mb-10 container mx-auto grid grid-cols-1 md:grid-cols-3 gap-6'>
<div>
   <h3 className='text-xl font-bold mb-4'>Core Courses</h3>
   <ul className='space-y-2 text-lg'>
    <Link href="#"><li className='py-1'>Programming Fundamental</li></Link>
    <Link href="#"><li className='py-1'>Web2 Using Next.JS</li></Link>
...
<ul className='space-y-2 text-lg'> 
    ...
    <Link href="#"><li className='py-1'>Artificial Intelligence (Ai)</li></Link>
    <Link href="#"><li className='py-1'>Ambient Computing and IoT</li></Link>
    <Link href="#"><li className='py-1'>Genomics and Bioinformative</li></Link>
