...
export default class ImagesCaurosal extends Component {
    render(): ReactNode {
        let data = [
            {
            img: Image1,
        ...
        <Slider {...settings} className="w-full">
            {
                data.map((val, index) => {
                    return(
                        <div className="px-3 xl-lg:px-1 group mb-2 md:mb-5 relative overflow-hidden cursor-pointer outline-none">
